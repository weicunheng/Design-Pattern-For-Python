...
实现
    ...
    2. Keyboard、Mouse、Monitor 和 Computer 是实现了 ComputerPart 接口的实体类
    3. 定义访问者操作类 ComputerPartVisitor
    4. Computer 使用实体访问者来执行相应的动作。 
"""
import abc
...
class Computer(ComputerPart):
    ...
    def __init__(self):
        self.parts = [Keyboard(), Mouse(), Monitor()]
...
class ComputerPartVisitor():
    # 表示访问者的接口
    def visit(self, Computercomputer):
        print("{} visit".format(Computercomputer))
